...
async function hashPassword(password) {
  ...
  return Array.from(new Uint8Array(hashedBuffer)).map(byte => byte.toString(16).padStart(2, '0')).join('');
}
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  async function saveChanges() {
      ...
      console.log({ username, email, currentPassword, newPassword, repeatPassword });
